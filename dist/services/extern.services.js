...
export const createExtern = async (extern) => {
...
export const getExternProfile = async (viewer_id) => {
    if (!viewer_id) {
...
export const getExternPersonalDetails = async (viewer_id) => {
    if (!viewer_id) {
        throw new Error("viewer id were not received properly");
    }
...
export const getExternOrganizationCredentials = async (viewer_id) => {
    if (!viewer_id) {
        throw new Error("viewer id were not received properly");
    }
...
export const getExternBasicDetails = async (viewer_id) => {
    if (!viewer_id) {
        throw new Error("viewer id were not received properly");
    }
...
export const updateExternOrganizationDetails = async (viewer_id, newOrganisationDetails) => {
...
export const updateExternVerificationDocuments = async (viewer_id, newDocument) => {
...
export const updateExternPhoto = async (viewer_id, newPhoto) => {
...
export const updateExternEmail = async (viewer_id, newEmail) => {
...
export const updateExternPhone = async (viewer_id, newPhone) => {
...
export const updateExternPassword = async (viewer_id, newPassword) => {
...
//# sourceMappingURL=extern.services.js.map