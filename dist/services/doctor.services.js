...
export const getDoctorProfileCredentials = async (doctor_id) => {
    if (!doctor_id) {
        throw new Error("Doctor id were not received properly");
    }
...
export const getDoctorBasicDetails = async (doctor_id) => {
    if (!doctor_id) {
        throw new Error("Doctor id were not received properly");
    }
...
export const updateDoctorProfileCredentials = async (doctor_id, newCredentials) => {
...
export const updateDoctorVerificationDocument = async (doctor_id, newDocument) => {
...
export const updateDoctorPhoto = async (doctor_id, newPhoto) => {
...
export const updateDoctorEmail = async (doctor_id, newEmail) => {
...
export const updateDoctorPhone = async (doctor_id, newPhone) => {
...
export const updateDoctorPassword = async (doctor_id, newPassword) => {
...
//# sourceMappingURL=doctor.services.js.map