...
export const getHospitalProfile = async (hospital_id) => {
    if (!hospital_id) {
...
export const getHospitalDetails = async (hospital_id) => {
    if (!hospital_id) {
        throw new Error("Hospital id were not received properly");
    }
...
export const getHospitalProfileCredentials = async (hospital_id) => {
    if (!hospital_id) {
        throw new Error("Hospital id were not received properly");
    }
...
export const updateHospitalProfileCredentials = async (hospital_id, newCredentials) => {
...
export const updateHospitalVerificationDocuments = async (hospital_id, newDocument) => {
...
export const updateHospitalPhoto = async (hospital_id, newPhoto) => {
...
export const updateHospitalEmail = async (hospital_id, newEmail) => {
...
export const updateHospitalPhone = async (hospital_id, newPhone) => {
...
export const updateHospitalPassword = async (hospital_id, newPassword) => {
...
//# sourceMappingURL=hospital.services.js.map