...
cloudinaryRoute.post('/photo', upload.single('photo'), cloudinaryController.uploadImage);
// Route for uploading a single document
// The client must send the file in a form field named 'doc'
cloudinaryRoute.post('/doc', upload.single('doc'), cloudinaryController.uploadDocument);
cloudinaryRoute.delete('/asset', cloudinaryController.deleteAsset);
