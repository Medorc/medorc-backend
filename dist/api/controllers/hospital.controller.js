...
export const handleGetHospitalProfile = async (req, res) => {
    try {
...
export const handleGetHospitalDetails = async (req, res) => {
    try {
        ...
        if (userPayload.role == "hospital") {
            ...
            if (!userId) {
                return res.status(400).json({ error: "Hospital id must be provided" });
            }
            hospitalDetails = await hospitalService.getHospitalDetails(userId);
        }
        else {
...
export const handleGetHospitalProfileCredentials = async (req, res) => {
    try {
        const userPayload = req.user;
        if (!userPayload || typeof userPayload !== "object") {
            return res.status(400).json({ error: "Invalid token payload." });
...
export const handleUpdateHospitalProfileCredentials = async (req, res) => {
    try {
        const userPayload = req.user;
        if (!userPayload || typeof userPayload !== "object") {
            return res.status(400).json({ error: "Invalid token payload." });
        ...
        let newCredentials = req.body.newCredentials;
        if (!newCredentials) {
...
export const handleUpdateHospitalVerificationDocuments = async (req, res) => {
    try {
        const userPayload = req.user;
        if (!userPayload || typeof userPayload !== "object") {
            return res.status(400).json({ error: "Invalid token payload." });
...
export const handleUpdateHospitalPhoto = async (req, res) => {
    try {
        const userPayload = req.user;
        if (!userPayload || typeof userPayload !== "object") {
            return res.status(400).json({ error: "Invalid token payload." });
...
export const handleUpdateHospitalEmail = async (req, res) => {
    try {
        const userPayload = req.user;
        if (!userPayload || typeof userPayload !== "object") {
            return res.status(400).json({ error: "Invalid token payload." });
...
export const handleUpdateHospitalPhone = async (req, res) => {
    try {
        const userPayload = req.user;
        if (!userPayload || typeof userPayload !== "object") {
            return res.status(400).json({ error: "Invalid token payload." });
...
export const handleUpdateHospitalPassword = async (req, res) => {
    try {
        const userPayload = req.user;
        if (!userPayload || typeof userPayload !== "object") {
            return res.status(400).json({ error: "Invalid token payload." });
