...
export const handleGetExternProfile = async (req, res) => {
    try {
        ...
        if (userPayload.role == "extern") {
            ...
            if (!userId) {
                return res.status(400).json({ error: "Viewer id must be provided" });
            }
...
export const handleGetExternPersonalDetails = async (req, res) => {
    try {
        const userPayload = req.user;
        if (!userPayload || typeof userPayload !== "object") {
            return res.status(400).json({ error: "Invalid token payload." });
...
export const handleGetExternOrganizationCredentials = async (req, res) => {
    try {
        const userPayload = req.user;
        if (!userPayload || typeof userPayload !== "object") {
            return res.status(400).json({ error: "Invalid token payload." });
...
export const handleGetExternBasicDetails = async (req, res) => {
    try {
        const userPayload = req.user;
        if (!userPayload || typeof userPayload !== "object") {
            return res.status(400).json({ error: "Invalid token payload." });
...
export const handleUpdateExternOrganizationCredentials = async (req, res) => {
    try {
        const userPayload = req.user;
        ...
        const userId = String(userPayload.id);
        const newOrganizationCredentials = req.body.newOrganizationCredentials;
...
export const handleUpdateExternVerificationDocuments = async (req, res) => {
    try {
        const userPayload = req.user;
        if (!userPayload || typeof userPayload !== "object") {
            return res.status(400).json({ error: "Invalid token payload." });
...
export const handleUpdateExternPhoto = async (req, res) => {
    try {
        const userPayload = req.user;
        if (!userPayload || typeof userPayload !== "object") {
            return res.status(400).json({ error: "Invalid token payload." });
...
export const handleUpdateExternEmail = async (req, res) => {
    try {
        const userPayload = req.user;
        if (!userPayload || typeof userPayload !== "object") {
            return res.status(400).json({ error: "Invalid token payload." });
...
export const handleUpdateExternPhone = async (req, res) => {
    try {
        const userPayload = req.user;
        if (!userPayload || typeof userPayload !== "object") {
            return res.status(400).json({ error: "Invalid token payload." });
...
export const handleUpdateExternPassword = async (req, res) => {
    try {
        const userPayload = req.user;
        if (!userPayload || typeof userPayload !== "object") {
            return res.status(400).json({ error: "Invalid token payload." });
...
//# sourceMappingURL=extern.controller.js.map